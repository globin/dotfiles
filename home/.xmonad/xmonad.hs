...
myKeyBindings =
  [
    ...
    , ((myModMask, xK_f), spawn "firefox-trunk")
    , ((myModMask, xK_x), spawn "xrandr --output VGA2 --off")
    , ((myModMask .|. shiftMask, xK_x), spawn "xrandr --output VGA2 --auto --left-of LVDS1")
    , ((myModMask, xK_Print), spawn "gnome-screenshot -a")
    , ((myModMask .|. shiftMask, xK_l), spawn "i3lock -n -c 000000")
...
myManagementHooks = [
  ...
  , (className =? "Firefox-trunk") --> doF (W.shift "8:Web")
  ]
